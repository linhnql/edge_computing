...
plt.legend(loc='lower center', bbox_to_anchor=(0.25, -0.25), fancybox=True, shadow=True)
...
plt.grid()
plt.legend(loc='lower center', bbox_to_anchor=(0.75, -0.25), fancybox=True, shadow=True)

file_png = 'compare_p.png'

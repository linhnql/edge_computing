...
for i in range(t_range):
    ...
    fixed_2_data.append([avg_rewards_time_list[-1], avg_rewards_bak_list[-1], avg_rewards_bat_list[-1]])
    if dones:
        env.reset()

# print('--RESULTS--')
# print('{:15}{:30}{:10}{:10}{:10}'.format('method','total cost','time','bak','bat'))
# print('{:15}{:<30}{:<10.5}{:<10.5}{:<10.5}'.format('fixed 1kW',avg_rewards[-1], avg_rewards_time_list[-1], avg_rewards_bak_list[-1], avg_rewards_bat_list[-1]))
# end_time = time.time()
# print('elapsed time:', end_time-start_time)

# #total cost
# df=pd.DataFrame({'x': range(t_range), 'y_5': avg_rewards})
...
# plt.legend()
# plt.grid()
# my_file = 'p='+str(x)+'/fixed1/fixed1_total_p='+str(x)+'_.xlsx'
# export_excel = df.to_excel (os.path.join(my_path, my_file), index = None, header=True)
# my_file = 'p='+str(x)+'/fixed1/fixed1_total_p='+str(x)+'_.png'
# plt.savefig(os.path.join(my_path, my_file))
# plt.show()
# #time cost
# dft=pd.DataFrame({'x': range(t_range), 'y_5': avg_rewards_time_list})
# plt.xlabel("Time Slot")
...
# plt.legend()
# plt.grid()
# my_file = 'p='+str(x)+'/fixed1/fixed1_time_p='+str(x)+'_.xlsx'
# export_excel = dft.to_excel (os.path.join(my_path, my_file), index = None, header=True)
# my_file = 'p='+str(x)+'/fixed1/fixed1_time_p='+str(x)+'_.png'
# plt.savefig(os.path.join(my_path, my_file))
# plt.show()
# #bak-up cost
# dfbak=pd.DataFrame({'x': range(t_range), 'y_5': avg_rewards_bak_list})
# plt.xlabel("Time Slot")
...
# plt.legend()
# plt.grid()
# my_file = 'p='+str(x)+'/fixed1/fixed1_backup_p='+str(x)+'_.xlsx'
# export_excel = dfbak.to_excel (os.path.join(my_path, my_file), index = None, header=True)
# my_file = 'p='+str(x)+'/fixed1/fixed1_backup_p='+str(x)+'_.png'
# plt.savefig(os.path.join(my_path, my_file))
# plt.show()
# #battery cost
# dfbat=pd.DataFrame({'x': range(t_range), 'y_5': avg_rewards_bat_list})
# plt.xlabel("Time Slot")
...
# plt.legend()
# plt.grid()
# my_file = 'p='+str(x)+'/fixed1/fixed1_battery_p='+str(x)+'_.xlsx'
# export_excel = dfbat.to_excel (os.path.join(my_path, my_file), index = None, header=True)
# my_file = 'p='+str(x)+'/fixed1/fixed1_battery_p='+str(x)+'_.png'
# plt.savefig(os.path.join(my_path, my_file))
# plt.show()
# #energy cost
# dfe=pd.DataFrame({'x': range(t_range), 'y_5': avg_rewards_energy_list})
# plt.xlabel("Time Slot")
...
# plt.legend()
# plt.grid()
# my_file = 'p='+str(x)+'/fixed1/fixed1_energy_p='+str(x)+'_.xlsx'
# export_excel = dfe.to_excel (os.path.join(my_path, my_file), index = None, header=True)
# my_file = 'p='+str(x)+'/fixed1/fixed1_energy_p='+str(x)+'_.png'
# plt.savefig(os.path.join(my_path, my_file))
# plt.show()

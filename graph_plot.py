...
# ppo area chart
xls_file_names = ['p='+str(val)+'/avg_time_p='+str(val)+'_.xlsx', 'p='+str(
    val)+'/avg_backup_p='+str(val)+'_.xlsx', 'p='+str(val)+'/avg_battery_p='+str(val)+'_.xlsx']
...
xx = range(rng)
fig = plt.stackplot(xx, plot_list, edgecolor='black', labels=[
...
plt.legend(loc='lower center', bbox_to_anchor=(
    0.5, 0.), ncol=3, fancybox=True, shadow=True)

...
df = pd.DataFrame({'x': range(t_range), 'y_1': avg_rewards_ppo, 'y_2': avg_rewards_random,
                  'y_3': avg_rewards_myopic, 'y_4': avg_rewards_fixed_1, 'y_5': avg_rewards_fixed_2, 'y_6': avg_dqn_reward_list})
...
# plt.subplot(2,2,1)
df1 = pd.DataFrame(ppo_data, columns=[
                   'delay cost', 'back-up power cost', 'battery cost'])
df1.plot.area()
...
# plt.subplot(2,2,2)
df2 = pd.DataFrame(random_data, columns=[
                   'delay cost', 'back-up power cost', 'battery cost'])
df2.plot.area()
# plt.plot(range(t_range), avg_rewards_ppo)
plt.grid()
...
# plt.subplot(2,2,3)
df5 = pd.DataFrame(fixed_1_data, columns=[
                   'delay cost', 'back-up power cost', 'battery cost'])
df5.plot.area()
...
# plt.subplot(2,2,4)
df5 = pd.DataFrame(fixed_2_data, columns=[
                   'delay cost', 'back-up power cost', 'battery cost'])
df5.plot.area()
# plt.plot(range(t_range), avg_rewards_ppo)
plt.grid()
